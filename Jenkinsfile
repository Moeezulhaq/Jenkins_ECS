...
//     )
  ...
  stages { 
        ...
        steps {
        sh "aws ecs create-service --service-name testing --cluster mycluster --task-definition arn:aws:ecs:us-east-1:489994096722:task-definition/sleep360:2 --launch-type EC2 --desired-count 2  --region us-east-1"    
        }
    }
